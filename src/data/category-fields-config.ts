  ...
  BEAUTY: [
    {
      ...
      type: 'multi_select',
      instruction: 'Selecciona los tipos de servicio que ofreces.',
      options: [
        'Novia / Quinceañera (look completo)',
        'Social / Fiesta',
        'Corporativo / Editorial',
        'Infantil',
        'Caracterización / FX',
        'Novio / Caballero',
        'Grupal (misma sesión, varias personas)',
      ],
    },
    {
      key: 'productos_marcas',
      label: 'Productos y marcas que utilizas',
      type: 'multi_select',
      instruction: 'Selecciona el tipo de productos que usas.',
      options: [
        'Alta gama (MAC, NARS, Charlotte Tilbury, Estée Lauder)',
        'Profesional (Kryolan, Ben Nye, RCMA)',
        'Orgánico / Cruelty-free',
        'Hipoalergénico / Piel sensible',
        'Otro',
      ],
    },
    {
      key: 'incluye_prueba',
      label: 'Incluye prueba previa',
      type: 'switch',
      instruction: 'Indica si tu servicio incluye una prueba antes del evento.',
    },
    {
      key: 'tiempo_por_persona',
      label: 'Tiempo estimado por persona',
      type: 'number',
      instruction: 'Cuántos minutos tarda tu servicio por persona.',
      unit: 'min',
    },
    {
      key: 'que_incluye',
      ...
      type: 'multi_select',
      instruction: 'Selecciona lo que incluye tu servicio de belleza.',
      options: [
        'Kit completo de productos',
        'Retoque durante el evento',
        'Preparación de piel (skincare previo)',
        'Pestañas postizas',
        'Accesorios para el cabello',
        'Traslado al domicilio/venue incluido',
        'Asesoría de imagen / colorimetría',
      ],
    },
    {
      key: 'requerimientos_sitio',
      ...
      instruction: 'Selecciona lo que necesitas en el lugar del evento.',
      options: [
        'Espacio con buena iluminación natural o lámparas',
        'Silla alta o sillón reclinable',
        'Espejo de cuerpo completo',
        'Conexión eléctrica (secadora, plancha, vaporizador)',
        'Mesa o superficie de trabajo',
        'Acceso a agua potable',
        'Soy autónomo, llevo todo lo necesario',
      ],
    },
    {
      key: 'not_included',
