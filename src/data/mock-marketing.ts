...
export const mockCampaigns: Campaign[] = [
  ...
  },
  {
    ...
    internal_name: 'Promo Banquetes Abril',
    external_name: 'Cupon de banquetes',
    description: 'Promocion creada por el proveedor: 10% off en banquetes con codigo BANQUETE10. El proveedor absorbe el descuento completo.',
    discount_pct: 10,
    ...
    status: 'active',
    source: 'provider',
    owner_provider_id: '00000000-0000-0000-0000-000000000002',
    coupon_code: 'BANQUETE10',
    usage_limit: 100,
    used_count: 3,
    max_uses_per_user: 1,
...
export const mockCampaignSubscriptions: CampaignSubscription[] = [
  ...
  },
  {
    ...
    campaign_id: '60000000-0000-0000-0000-000000000103',
    service_id: '10000000-0000-0000-0000-000000000002',
    provider_id: '00000000-0000-0000-0000-000000000002',
    status: 'active',
    created_at: '2026-03-25T00:00:00Z',
