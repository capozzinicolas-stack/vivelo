...
import { getServiceById, updateService, createExtra, updateExtra as updateExtraQuery, deleteExtra } from '@/lib/supabase/queries';
...
import type { ServiceCategory, Extra } from '@/types/database';
