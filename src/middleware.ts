...
const publicPaths = ['/', '/login', '/register', '/home', '/search', '/services', '/servicios', '/carrito', '/checkout', '/api/stripe/webhook', '/auth/callback', '/reset-password', '/politica-de-privacidad', '/politica-de-cancelaciones', '/quien-somos'];
