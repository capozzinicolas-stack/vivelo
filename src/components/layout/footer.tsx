    ...
    <footer>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <Link href="/">
                <Image src="/logo-vivelo.png" alt="Vivelo" width={140} height={40} className="h-10 w-auto brightness-0 invert" />
              </Link>
              <div className="flex items-center gap-3">
                <SocialIcon href="https://www.instagram.com/solo.vivelo/" label="Instagram">
                ...
                <SocialIcon href="https://www.tiktok.com/@solovivelo" label="TikTok">
                ...
                <SocialIcon href="https://www.facebook.com/people/Vivelo/61577239706576/" label="Facebook">
                ...
                <SocialIcon href="https://wa.me/5215519080884" label="WhatsApp">
            ...
            {footerSections.map((section, idx) => (
              <div key={idx} className="space-y-3">
                {section.title && <h3 className="font-bold text-lg">{section.title}</h3>}
                {!section.title && <div className="h-7" />}
      ...
      <div className="bg-off-white">
        <div className="container mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-sm text-muted-foreground">&copy; Copyright &copy; 2026. Vivelo</p>
          <div className="flex items-center gap-3">
            <span className="text-xs text-muted-foreground font-semibold bg-blue-600 text-white px-2 py-0.5 rounded">VISA</span>
            <span className="text-xs text-muted-foreground font-semibold bg-red-500 text-white px-2 py-0.5 rounded">MC</span>
            <span className="text-xs text-muted-foreground font-semibold bg-blue-800 text-white px-2 py-0.5 rounded">AMEX</span>
          </div>
        </div>
      </div>
    </footer>
